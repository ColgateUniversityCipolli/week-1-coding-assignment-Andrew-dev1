...
\end{knitrout}
\caption{The original copied collatz plot}
\label{CollatzPlot1}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{knitrout}
\caption{Slightly tweaked seeded plot}
\label{CollatzPlot2}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{alltt}
\hlkwd{set.seed}\hldef{(}\hlnum{1}\hldef{)}
\hlkwd{canvas_collatz}\hldef{(}\hlkwc{colors} \hldef{=} \hlkwd{colorPalette}\hldef{(}\hlsng{"vrolik4"}\hldef{),} \hlkwc{background} \hldef{=} \hlsng{"#dbdbdb"}\hldef{,} \hlkwc{n}\hldef{=} \hlnum{72}\hldef{,} \hlkwc{angle.odd} \hldef{=} \hlopt{-}\hlnum{0.05}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
%Code to insert a figure [H]ere
...
\begin{alltt}
\hlkwd{set.seed}\hldef{(}\hlnum{1}\hldef{)}
\hlkwd{canvas_collatz}\hldef{(}\hlkwc{colors} \hldef{=} \hlkwd{colorPalette}\hldef{(}\hlsng{"blossom"}\hldef{),} \hlkwc{background} \hldef{=} \hlsng{"#000000"}\hldef{,} \hlkwc{n}\hldef{=} \hlnum{300}\hldef{,} \hlkwc{angle.odd} \hldef{=} \hlopt{-}\hlnum{0.3}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}
%Code to insert a figure [H]ere
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{numbers} \hlkwb{<-} \hlnum{1}\hlopt{:}\hlnum{10}
\hldef{numbers}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{computed} \hlkwb{<-} \hlkwd{rep}\hldef{(}\hlkwc{x} \hldef{=}\hlnum{NA}\hldef{,} \hlkwc{times} \hldef{=} \hlkwd{length}\hldef{(numbers))}
\hlkwa{for} \hldef{(num} \hlkwa{in} \hlnum{1}\hlopt{:}\hlkwd{length}\hldef{(numbers))\{}
  \hldef{current} \hlkwb{<-} \hldef{numbers[num]}
  \hldef{computed[num]} \hlkwb{<-} \hlnum{2}\hlopt{^}\hldef{(current}\hlopt{+}\hlnum{1}\hldef{)} \hlopt{+} \hlnum{2}\hlopt{^}\hldef{(current}\hlopt{-}\hlnum{1}\hldef{)}
\hldef{\}}
\hldef{computed}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{which}\hldef{(computed} \hlopt{==} \hlnum{40}\hldef{)}
\end{alltt}
\begin{verbatim}
## [1] 4
\end{verbatim}
